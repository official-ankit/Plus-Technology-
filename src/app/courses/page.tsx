...
const courses = [
  ...
  {
    id: 'android-native',
    title: 'Android App Development (Native)',
    description: 'Build native Android apps using Kotlin/Java, Material Design, Jetpack components, REST APIs, and Play Store deployment.',
    instructor: 'Plus Technology Institute',
    rating: 4.8,
    students: 3100,
    duration: '4 Months',
  ...
  {
    id: 'ios-swift',
    title: 'iOS App Development (Swift, UIKit & SwiftUI)',
    description: 'Develop native iOS apps with Swift, UIKit, and SwiftUI. Learn MVVM, networking, persistence, and App Store publishing.',
    instructor: 'Plus Technology Institute',
    rating: 4.9,
    students: 2700,
    duration: '4 Months',
  ...
  },
  {
    ...
    description: 'Build cross-platform mobile apps with React Native, TypeScript, navigation, native modules, and API integration for iOS and Android.',
    instructor: 'Plus Technology Institute',
    rating: 4.8,
    students: 3500,
    duration: '3 Months',
  ...
  },
  {
    ...
    description: 'Create beautiful cross-platform apps with Flutter and Dart. Cover widgets, state management, Firebase, and app releases.',
    instructor: 'Plus Technology Institute',
    rating: 4.8,
    students: 3300,
    duration: '3 Months',
  ...
  {
    id: 'ionic',
    title: 'Ionic (Cross Platform)',
    description: 'Build hybrid mobile apps using Ionic, Capacitor, and Angular/React. Learn plugins, native features, and deployment workflows.',
    instructor: 'Plus Technology Institute',
    rating: 4.6,
    students: 1900,
    duration: '2 Months',
